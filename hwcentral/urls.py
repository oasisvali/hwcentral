...
urlpatterns += patterns(core.views,
                        ...
                        url(UrlNames.PASSWORD_CHANGE.url_matcher,dynamic_router,
...
if settings.DEBUG:
    ...
    urlpatterns += patterns('',
                            ...
                            url(r'^accounts/password_change/$',
                                    ...
                                    {'post_change_redirect' : '/accounts/password_change/done/','template_name':'/home/hrishikesh/hwcentral/core/templates/authenticated/changepassword/changepassword.html'},
