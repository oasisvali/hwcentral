...
class Assignment(models.Model):
    ...
    path = models.FilePathField(unique=True, path=ASSIGNMENTS_ROOT, recursive=True, max_length=MAX_CHARFIELD_LENGTH,
...
class Submission(models.Model):
    ...
    path = models.FilePathField(unique=True, path=SUBMISSIONS_ROOT, recursive=True, max_length=MAX_CHARFIELD_LENGTH,
