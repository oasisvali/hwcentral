...
function draw_parent_child_single_subjectroom_performance(arraydata,subject_room,subject_teacher,subjectteacher_data,chart_width,chart_height,child_id) {
    ...
    var chart = new google.visualization.ColumnChart(document.getElementById('single_subjectroom_bargraph'+child_id));
