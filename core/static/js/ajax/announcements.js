    ...
    $.getJSON(AJAX_ENDPOINT + "announcements/", function (announcements_data) {
        ...
        if (announcements_data.length > 0) {
            ...
            for(var i = 0; i<announcements_data.length; i++) {
                ...
                formatted_announcements += "<li><div><span class='announcement_source'>" + announcement_row.source + "</span><span class='announcement_target'><span class='glyphicon glyphicon-arrow-right'></span>" + announcement_row.target + "</span><span class='announcement_timestamp'>" + announcement_row.timestamp + "</span></div><div class='announcement_message'>" + announcement_row.message + "</div></li>";
            }
        }
