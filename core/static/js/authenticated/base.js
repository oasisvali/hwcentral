...
if (typeof HWCentralAppContext !== 'undefined') {
    ...
    // else if mobile device show message (only once)
        ...
        if (alerted != 'yes') {
            alert("It appears you are using a mobile device! If you are on an android device, we recommend downloading the OpenShiksha app available on the Play Store. For the best user experience, please use OpenShiksha on a desktop or laptop.");
