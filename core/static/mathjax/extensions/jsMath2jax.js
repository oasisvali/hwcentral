...
MathJax.Extension.jsMath2jax = {
    version: "2.5.0", config: {preview: "TeX"}, PreProcess: function (b) {
        if (!this.configured) {
        ...
        var c = b.getElementsByTagName("span"), a;
        ...
        if (c.getElementsByTagName("script").length === 0) {
            var b = c.parentNode, a = this.createMathTag(d, c.innerHTML);
            if (c.nextSibling) {
        ...
        if (b === "TeX") {
            b = [this.filterPreview(a.innerHTML)]
        }
        if (b) {
