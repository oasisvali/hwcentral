...
MathJax.Hub.Register.StartupHook("HTML-CSS Jax Ready", function () {
    ...
    a.menclose.Augment({
        toHTML: function (ac) {
            var j = this.getValues("notation", "thickness", "padding", "mathcolor", "color");
            ...
            var V = this.HTMLgetMu(ac), af = this.HTMLgetScale();
            ...
            var K = v.bbox.h + X + N, P = v.bbox.d + X + N, o = v.bbox.w + 2 * (X + N);
            var O = b.createFrame(z, K + P, 0, o, N, "none");
            O.id = "MathJax-frame-" + this.spanID;
            b.addBox(z, O);
            z.insertBefore(O, v);
            var s = 0, U = 0, u = 0, A = 0, M = 0, J = 0;
            var S, g;
            var I, ad, Q;
            if (!j.mathcolor) {
                j.mathcolor = "black"
            ...
            var k = MathJax.Hub.SplitList(j.notation), q = {};
                ...
                switch (Y) {
                    ...
                    case a.NOTATION.ROUNDEDBOX:
                        if (b.useVML) {
                            ...
                            I = Math.floor(4000 * (o - 2 * N)), ad = Math.floor(4000 * (K + P - 2 * N));
                            this.HTMLvmlElement(g, "shape", {
                                ...
                                path: "m " + Q + ",0 qx 0," + Q + " l 0," + (ad - Q) + " qy " + Q + "," + ad + " l " + (I - Q) + "," + ad + " qx " + I + "," + (ad - Q) + " l " + I + "," + Q + " qy " + (I - Q) + ",0 x e",
                                coordsize: I + "," + ad
                            })
                        } else {
                            if (!S) {
                    ...
                    case a.NOTATION.UPDIAGONALARROW:
                        if (b.useVML) {
                            ...
                            var aa = Math.sqrt(o * o + (K + P) * (K + P)), ae = 1 / aa * 10 * this.scale / b.em * N / 0.075;
                            I = o * ae;
                            ad = (K + P) * ae;
                            var F = o - N / 2, C = N / 2;
                            if (C + ad - 0.4 * I < 0) {
                            ...
                            this.HTMLsvgElement(S.firstChild, "polygon", {
                                points: this.HTMLpx(F) + "," + this.HTMLpx(C) + " " + this.HTMLpx(F - I - 0.4 * ad) + "," + this.HTMLpx(C + ad - 0.4 * I) + " " + this.HTMLpx(F - 0.7 * I) + "," + this.HTMLpx(C + 0.7 * ad) + " " + this.HTMLpx(F - I + 0.4 * ad) + "," + this.HTMLpx(C + ad + 0.4 * I) + " " + this.HTMLpx(F) + "," + this.HTMLpx(C),
                                fill: j.mathcolor,
                                stroke: "none"
                            })
                        }
                    ...
                    case a.NOTATION.PHASORANGLE:
                        ...
                        if (b.useVML) {
                            ...
                            this.HTMLvmlElement(g, "shape", {
                                ...
                                path: "m " + this.HTMLpt(X + N / 2, N / 2) + " l " + this.HTMLpt(N / 2, K + P - N) + " " + this.HTMLpt(o - N / 2, K + P - N) + " e",
                            ...
                            this.HTMLsvgElement(S.firstChild, "path", {d: "M " + this.HTMLpx(X) + ",1L 1," + this.HTMLpx(K + P - N) + " L " + this.HTMLpx(o) + "," + this.HTMLpx(K + P - N)});
                    ...
                    case a.NOTATION.RADICAL:
                        if (b.useVML) {
                            ...
                            this.HTMLvmlElement(g, "shape", {
                                style: {width: this.HTMLpx(o), height: this.HTMLpx(K + P)},
                                path: "m " + this.HTMLpt(N / 2, 0.6 * (K + P)) + " l " + this.HTMLpt(X, K + P - N) + " " + this.HTMLpt(2 * X, N / 2) + " " + this.HTMLpt(o, N / 2) + " e",
                                coordsize: this.HTMLpt(o, K + P)
                            });
                            M = X
                        } else {
                            ...
                            this.HTMLsvgElement(S.firstChild, "path", {d: "M 1," + this.HTMLpx(0.6 * (K + P)) + " L " + this.HTMLpx(X) + "," + this.HTMLpx(K + P) + " L " + this.HTMLpx(2 * X) + ",1 L " + this.HTMLpx(o) + ",1"});
                    ...
                    case a.NOTATION.LONGDIV:
                        if (b.useVML) {
                            ...
                            this.HTMLsvgElement(S.firstChild, "path", {d: "M " + this.HTMLpx(o) + ",1 L 1,1 a" + this.HTMLpx(X) + "," + this.HTMLpx((K + P) / 2 - N) + " 0 0,1 1," + this.HTMLpx(K + P - 2 * N)});
            ...
            this.HTMLsvgElement(i, "g", {fill: "none", stroke: j, "stroke-width": k * b.em});
            return i
            ...
            if ((document.documentMode || 0) < 9) {
                ...
                if (!document.namespaces[e]) {
                    if (document.documentMode && document.documentMode === 8) {
                        ...
                        document.createStyleSheet().addRule(e + "\\: *", "{behavior: url(#default#VML)}")
                    }
                }
            }
        }
