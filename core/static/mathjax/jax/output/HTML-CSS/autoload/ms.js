...
MathJax.Hub.Register.StartupHook("HTML-CSS Jax Ready", function () {
    ...
    a.ms.Augment({
        toHTML: function (e) {
            ...
            var d = this.getValues("lquote", "rquote");
            var f = this.data.join("");
            this.HTMLhandleVariant(e, this.HTMLgetVariant(), d.lquote + f + d.rquote);
    ...
    a.ms.prototype.defaults.mathvariant = "monospace";
