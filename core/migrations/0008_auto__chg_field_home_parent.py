...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Home.parent'
        db.alter_column(u'core_home', 'parent_id',
                        self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True,
                                                                                 to=orm['auth.User']))

    def backwards(self, orm):
        # Changing field 'Home.parent'
        db.alter_column(u'core_home', 'parent_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(primary_key=True, to=orm['auth.User']))
