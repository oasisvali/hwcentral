...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'core_question', (
            ...
            ('conf', self.gf('django.db.models.fields.FilePathField')(
                path='/Users/oasis/.virtualenvs/djangopy2env/projects/hwcentral/core/questions', max_length=255,
                match='\\d+\\.xml')),
        ))
        ...
        db.create_table(u'core_subjectroom', (
            ...
            ('subject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Subject'])),
            ('teacher', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subjects_managed_set',
                                                                              to=orm['auth.User'])),
        ))
        ...
        db.create_table(u'core_home', (
            ('parent',
             self.gf('django.db.models.fields.related.ForeignKey')(related_name='homes_managed_set', primary_key=True,
                                                                   to=orm['auth.User'])),
        ))
        ...
        db.add_column(u'core_classroom', 'classTeacher',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1,
                                                                            related_name='classes_managed_set',
                                                                            to=orm['auth.User']),
                      keep_default=False)
        ...
        db.add_column(u'core_assignment', 'conf',
                      self.gf('django.db.models.fields.FilePathField')(default=1,
        ...
        db.alter_column(u'core_submission', 'path', self.gf('django.db.models.fields.FilePathField')(
            path='/Users/oasis/.virtualenvs/djangopy2env/projects/hwcentral/core/submissions', max_length=255,
            match='\\d+\\.xml'))
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_classroom', 'teacher',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='classes_managed_set',
                                                                            to=orm['auth.User']),
                      keep_default=False)
        ...
        raise RuntimeError(
            "Cannot reverse this migration. 'Assignment.assignmentType' and its values cannot be restored.")
        ...
        db.add_column(u'core_assignment', 'path',
                      self.gf('django.db.models.fields.FilePathField')(max_length=255,
                                                                       path='/Users/oasis/.virtualenvs/djangopy2env/projects/hwcentral/core/assignments',
                                                                       unique=True, recursive=True,
        ...
        # Changing field 'Submission.path'
        db.alter_column(u'core_submission', 'path', self.gf('django.db.models.fields.FilePathField')(max_length=255,
    ...
    models = {
        ...
        u'core.assignment': {
            ...
            'conf': ('django.db.models.fields.FilePathField', [],
                     {'path': "'/Users/oasis/.virtualenvs/djangopy2env/projects/hwcentral/core/assignments'",
                      'max_length': '255', 'match': "'\\\\d+\\\\.xml'"}),
