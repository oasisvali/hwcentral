...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Changing field 'Assignment.due'
        db.alter_column(u'core_assignment', 'due',
                        self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 12, 0, 0)))

        # Changing field 'Submission.timestamp'
        db.alter_column(u'core_submission', 'timestamp',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Assignment.due'
        db.alter_column(u'core_assignment', 'due', self.gf('django.db.models.fields.DateTimeField')(null=True))
