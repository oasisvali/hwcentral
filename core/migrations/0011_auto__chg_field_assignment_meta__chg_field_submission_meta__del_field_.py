...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'core_question_chapter')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Question.chapter'
        raise RuntimeError("Cannot reverse this migration. 'Question.chapter' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration        # Adding field 'Question.chapter'
        ...
        db.delete_table(db.shorten_name(u'core_question_chapter'))
    ...
    models = {
        ...
        u'core.question': {
            ...
            'chapter': ('django.db.models.fields.related.ManyToManyField', [],
                        {'to': u"orm['core.Chapter']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meta': ('django.db.models.fields.FilePathField', [],
